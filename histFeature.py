...
def histFeatureCV(roi_gray, maskX):
#    histR, binNumR = np.histogram(roi_gray, bins = 100)
    
    if maskX is None:
        histR = cv2.calcHist([roi_gray], [0], None, [256], [0,256])
    else:
        histR = cv2.calcHist([roi_gray], [0], maskX, [256], [0,256])
    
    
    binNumR = np.zeros((257,1), dtype = float)
...
print meanHist_m, sigmaHist_m, fwhmHist_m, highHist_m, lowHist_m, rmsHist_m, maxPopulation_m, rangeHist_m, percintileHist20_m, percintileHist40_m, percintileHist50_m, percintileHist60_m, percintileHist80_m



#using OpenCV
ret,threshInv = cv2.threshold(imgM,127,255,cv2.THRESH_BINARY_INV)
cv2.imwrite('Strauss_GL (83)_FlatMaskXXX.pgm', threshInv)
...
histMask = cv2.calcHist([img], [0], threshInv, [256], [0,256])
...
histMaskAry = np.asarray(histMask)

meanHist_m1, sigmaHist_m1, fwhmHist_m1, highHist_m1, lowHist_m1, rmsHist_m1, maxPopulation_m1, rangeHist_m1, percintileHist20_m1, percintileHist40_m1, percintileHist50_m1, percintileHist60_m1, percintileHist80_m1 = histFeatureCV(img, None)

print meanHist_m1, sigmaHist_m1, fwhmHist_m1, highHist_m1, lowHist_m1, rmsHist_m1, maxPopulation_m1, rangeHist_m1, percintileHist20_m1, percintileHist40_m1, percintileHist50_m1, percintileHist60_m1, percintileHist80_m1
